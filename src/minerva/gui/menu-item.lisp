...
(defclass menu-item (widget)
  ...
  (text-color :initarg :text-color :accessor menu-item-text-color :initform theme:default-color)
  (key-text-color :initarg :key-text-color :accessor menu-item-key-text-color :initform theme:default-color)
