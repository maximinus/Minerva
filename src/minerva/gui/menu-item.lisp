...
(defclass menu-item (widget)
  ((id :initarg :id :accessor menu-item-id :initform nil)
   ...
   (font-name :initarg :font-name :accessor menu-item-font-name :initform "inconsolata")
   (text-size :initarg :text-size :accessor menu-item-text-size :initform 12)
   (text-color :initarg :text-color :accessor menu-item-text-color :initform '(255 255 255 255))
   (key-text-color :initarg :key-text-color :accessor menu-item-key-text-color :initform '(190 190 190 255))
   (highlighted-color :initarg :highlighted-color :accessor menu-item-highlighted-color :initform '(70 70 70 255))
